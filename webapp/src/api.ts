...
export const walletApi = {
  ...
  sendTransaction: (to: string, amount: string, pin: string, memo?: string, feeLevel?: 'low' | 'medium' | 'high', assetId?: string) => 
    api.post('/transaction/send', { to, amount, pin, memo, feeLevel, assetId }),
